            ...
            <div className='card-header'>
              ...
              <div className='icons'>
                ...
                <svg width="54" height="54" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9 15.5455C9 11.9305 11.9305 9 15.5455 9H38.4545C42.0695 9 45 11.9305 45 15.5455V38.4545C45 42.0695 42.0695 45 38.4545 45H15.5455C11.9305 45 9 42.0695 9 38.4545V15.5455Z" fill="#D9D9D9"/>
